...
let compareNums = (num1, num2) => (num1 * num2)
...
function nameCheck(nameCh) { 

  if (nameCh === "Steven") {
    console.log("What's up Steven")
  } else if ( nameCh === "Bryan") {
    consolee.log("Hey Bryan")
  } else {
    console.log("Cool nam," + nameCh)
     }
}

// let whosHere = nameCheck("Steven")
// console.log(whosHere)
...
// let faveColor = faveColoFinder("green")
...
// let arrayOfNames = printAllNames(namesArr)
...
//console.log(ucWord(sampleString))
...
function emailCheck(email) {
  let firstEmail = email + ""
  let firstEmailCheck = firstEmail.trim
  firstEmail.includes('@')
...
// let checkingEmail = emailCheck("scottninlv@yahoo.com")
...
// function buyingChocolate(gold){
//   return gold/3

// }
// let totalfrogs = buyingChocolate(9)
...
// function buyingChocolate2(gold){
//   return gold/ 3


// }
// let totalfrogs = buyingChocolate2(4)
